...
class _HomePageState extends State<HomePage> {
  ...
  CarouselController controllerCorouselController = CarouselController();
  ...
  final AudioPlayer _audioPlayer =
      AudioPlayer(); //accessing the AudioPlayer library
    ...
    switch (response["command"]) {
      ...
      case "next":
        ...
        if (index + 1 > radios.length) {
          //agar jo play ho raha hai vo last element hoga toh
          newRadio = radios.firstWhere((element) => element.id == 1);
          radios.remove(
              newRadio); // ye karne se list rebuild ho jayegi aur page bhi change hoga.
          radios.insert(0, newRadio);
        } else {
          //agar jo play ho raha hai vo last chodkar koi bhi element hoga toh.
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                  ...
                  ListView(
                    ...
                    children: radios
                        .map((e) => ListTile(
                              ...
                              onTap: () {
                                int index = radios.indexOf(e);
                                print(index);
                                _selectedRadio = radios[index];
                                final colorHex = radios[index].color;
                                _selectedColor = Color(int.parse(colorHex));
                                controllerCorouselController.animateToPage(
                                    index,
      ...
      body: Stack(
        fit: StackFit.expand,
        children: [
          //Stackfit.expand centered the images
          VxAnimatedBox()
          ...
          radios != null
              ? CarouselSlider.builder(
                  carouselController: controllerCorouselController,
                  ...
                  itemBuilder: ((context, index, realIndex) {
                    ...
                    return VxBox(
                      ...
                      Positioned(
                        ...
                        right: 0.0,
                        child: VxBox(
                          // Categories label text at the bottom right corner is placed
                          child:
                      ...
                      Align(
                          // alignment for creating a button
                        ...
                        .clip(Clip
                            .antiAlias) // category label ka extra part jo border ke bahar ja raha tha vo border ki bahar ka clip ho jayega
                        ...
                        .withRounded(value: 120.0) //make rounded corners
                        .make()
                        .onInkDoubleTap(() {
                      _playMusic(rad
                          .url); // double click karne par dusra radio play hoga.
                    }).p16();
                  }),
